...
class AmountValidatorTest {
    ...
    void setUp() {
        ...
        validator.initialize(new com.catalis.annotations.ValidAmount() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
                return com.catalis.annotations.ValidAmount.class; 
            }
            @Override
    ...
    void shouldValidateAmountWithCurrencySpecificDecimalPlaces() {
        ...
        jpyValidator.initialize(new com.catalis.annotations.ValidAmount() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
    ...
    void shouldValidateMinMaxConstraints() {
        ...
        minMaxValidator.initialize(new com.catalis.annotations.ValidAmount() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
    ...
    void shouldValidateZeroAmount() {
        ...
        noZeroValidator.initialize(new com.catalis.annotations.ValidAmount() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
