...
class PasswordStrengthValidatorTest {
    ...
    void setUp() {
        ...
        validator.initialize(new com.catalis.annotations.ValidPasswordStrength() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
                return com.catalis.annotations.ValidPasswordStrength.class; 
            }
            @Override
    ...
    void shouldValidatePasswordLength() {
        ...
        customLengthValidator.initialize(new com.catalis.annotations.ValidPasswordStrength() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
    ...
    void shouldValidateCharacterTypeRequirements() {
        ...
        customCharTypesValidator.initialize(new com.catalis.annotations.ValidPasswordStrength() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
    ...
    void shouldValidateMinCharTypes() {
        ...
        minCharTypesValidator.initialize(new com.catalis.annotations.ValidPasswordStrength() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
        ...
        allCharTypesValidator.initialize(new com.catalis.annotations.ValidPasswordStrength() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
    ...
    void shouldRejectCommonPasswords() {
        ...
        noRejectCommonValidator.initialize(new com.catalis.annotations.ValidPasswordStrength() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
