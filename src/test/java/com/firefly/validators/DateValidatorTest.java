...
class DateValidatorTest {
    ...
    void setUp() {
        ...
        validator.initialize(new com.firefly.annotations.ValidDate() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
                return com.firefly.annotations.ValidDate.class; 
            }
            @Override
    ...
    void shouldValidateDifferentDateFormats() {
        ...
        ddMMyyyyValidator.initialize(new com.firefly.annotations.ValidDate() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
    ...
    void shouldValidateMinMaxConstraints() {
        ...
        minMaxValidator.initialize(new com.firefly.annotations.ValidDate() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
    ...
    void shouldValidateFuturePastConstraints() throws Exception {
        ...
        noPastValidator.initialize(new com.firefly.annotations.ValidDate() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
        ...
        noFutureValidator.initialize(new com.firefly.annotations.ValidDate() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
