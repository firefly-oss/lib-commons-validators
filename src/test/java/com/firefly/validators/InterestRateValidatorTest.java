...
class InterestRateValidatorTest {
    ...
    void setUp() {
        ...
        validator.initialize(new com.firefly.annotations.ValidInterestRate() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
                return com.firefly.annotations.ValidInterestRate.class; 
            }
            @Override
    ...
    void shouldValidateDecimalPlaces() {
        ...
        twoDecimalValidator.initialize(new com.firefly.annotations.ValidInterestRate() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
    ...
    void shouldValidateMinMaxConstraints() {
        ...
        minMaxValidator.initialize(new com.firefly.annotations.ValidInterestRate() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
    ...
    void shouldValidateZeroRate() {
        ...
        noZeroValidator.initialize(new com.firefly.annotations.ValidInterestRate() {
            @Override
            public Class<?>[] groups() { return new Class<?>[0]; }
            @Override
            public Class<? extends java.lang.annotation.Annotation> annotationType() { 
